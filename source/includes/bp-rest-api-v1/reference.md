...
| Resource | Base Route |
| --- | --- |
| [Components](#components-endpoint) | `/buddypress/v1/components` |
| [Members](#members-endpoint) | `/buddypress/v1/members` |
